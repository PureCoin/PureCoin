...
const string strMessageMagic = "PureCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PureCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1401045375;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3230685;
		if(fTestNet)
        {
            block.nNonce   = 3230685;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x908b1dcdbd861faaaa7fc5ea7dc8b96ac40ca6e569f9ad8f621ec6ae57ded9ad"));
        block.print();
